...
<div class="row my-5 justify-content-center">
  <div class="col-12 col-md-8">
    <h1 class="text-center mb-5">Conoce la experiencia de otros usuarios con los vendedores de tu comunidad de facebook</h1>
    @if (session('error'))
    ...
    <form method="POST" action="{{ route('search-reviews') }}" class="form">
      <div class="input-group input-group-lg">
        @csrf
        <input id="url" type="text" name="url" class="form-control @error('url') is-invalid @enderror" placeholder="Pega aquí la URL del perfil de facebook" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('url') }}" style="border-radius: .25rem 0 0 .25rem">
