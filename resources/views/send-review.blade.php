    ...
    <div class="col-sm-12 col-md-8 col-xl-8">
      ...
      <form action="{{ route('send-review.store') }}" class="mt-5" method="post" class="form" autocomplete="off">
        ...
        <div class="form-floating mb-3">
          ...
          <label for="reporterName">* Tu nombre </label>
          @error('reporter_name')
        ...
        <div class="form-floating mb-3">
          ...
          <label for="reporterProfileLink">* URL de tu perfil de facebook</label>
        ...
        <div class="form-floating mb-3">
          ...
          <label for="fbPostLink">* URL de tu post </label>
          ...
          @error('fb_post_link')
            <div id="fbPostLinkFeedback" class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
        ...
        <div class="form-floating mb-3">
          ...
          <label for="affectedName">* Nombre del perfil</label>
          @error('affected_name')
